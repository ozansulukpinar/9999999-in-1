...
DateTime donusturulen = Convert.ToDateTime("27.02.2019"); // İstem dili formatında yazılmalı.
...
double tamSayi = Math.Truncate(2.78); // Ondalıklı kısma bakmaz sadece tam kısmını teslim eder.
